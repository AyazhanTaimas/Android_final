...
class SportsRegistrationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        registerButton.backgroundTintList = ContextCompat.getColorStateList(requireContext(), R.color.grey)
    ...
    private fun setupTeacherClick() {
        selectTeacher.setOnClickListener { selectTeacher.showDropDown() }
    }

    private fun setupTimeClick() {
        selectTime.setOnClickListener { selectTime.showDropDown() }
    }
    ...
    private fun showRegistrationDialog(sport: String, teacher: String, time: String) {
        AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("Да") { dialog, _ ->
                Toast.makeText(requireContext(), "Вы записаны на $sport с $teacher в $time", Toast.LENGTH_SHORT).show()
                dialog.dismiss()
            }
