    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_docs ->
                    openFragment(DocumentsFragment(), R.id.nav_docs, "Документы")

                R.id.nav_finance ->
                    showPlaceholder("Финансовый кабинет", R.id.nav_finance)

                R.id.nav_repair ->
                    showPlaceholder("Запросы на ремонт", R.id.nav_repair)
